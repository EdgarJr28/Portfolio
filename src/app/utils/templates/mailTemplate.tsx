export function Template(name: string, mail: string, message: string) {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="bg-gray-100">
    <div class="max-w-screen-sm mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="text-center mt-4 text-gray-500 text-xs">
            <p>© ${new Date().getFullYear()} EdDev. All rights reserved.</p>
            <p><a href="#" class="hover:text-blue-600">Privacy Policy</a> | <a href="#" class="hover:text-blue-600">Terms of Use</a></p>
        </div>
    </div>
</body>
</html>
