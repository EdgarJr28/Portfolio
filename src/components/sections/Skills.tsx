...
const CATEGORY_ORDER: SkillCategory[] = ["Frontend", "Services", "Aprendiendo"];
...
function SkillTag({ name, index }: { name: string; index: number }) {
  return (
    <motion.div
      ...
      whileHover={{ borderColor: "rgba(240,240,240,0.6)", color: "#f0f0f0" }}
      viewport={{ once: true }}
      transition={{
...
export default function Skills() {
  ...
  return (
    <section id="skills" style={SECTION_STYLE}>
      ...
      <div className="lg:grid lg:grid-cols-[480px_1fr]" style={{ gap: "3rem", alignItems: "center" }}>
        <div className="hidden lg:block" style={{ position: "relative", height: "540px" }}>
          <SkillsLabCanvas />
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "3.5rem" }}>
          {CATEGORY_ORDER.map((category, ci) => (
            ...
            >
              ...
              >
                {category === "Aprendiendo" ? tr(t.skills.learning, lang) : category}
              </p>
