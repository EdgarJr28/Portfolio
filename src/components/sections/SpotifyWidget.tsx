...
export default function SpotifyWidget() {
  ...
  return (
    ...
    >
      {/* Avatar 3D a todo el ancho, de fondo — así las notas musicales no se cortan */}
      <div className="hidden md:block" style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        <SpotifyAvatarCanvas playing={!!track?.isPlaying} />
      </div>

      {/* Título — posición fija arriba, no afecta el centrado vertical de la tarjeta */}
      <div
        style={{
          position: "absolute",
          top: "96px",
      ...
      {/* Contenido flotando encima del canvas — centrado verticalmente en la sección */}
      <div
        style={{
          position: "relative",
          zIndex: 2,
          ...
          <AnimatePresence mode="wait">
            {track === undefined ? (
              ...
              <motion.div
                ...
                style={{ position: "relative", width: "280px", textAlign: "left" }}
              >
                {/* Glow de color dominante — respira mientras suena */}
                <motion.div
                  aria-hidden="true"
                  animate={
                    track.isPlaying
                ...
                >
                  ...
                  {/* Barra de progreso real, sincronizada con Spotify */}
